...
async execute(message,args,client) {
  ...
  .setColor("#F0EAD6")
  .setAuthor(`${message.author.username} stopped the music!`, "https://mfp-network.com/wp-content/uploads/2022/07/Braun-orange-weisses-Logo-mit-Illustration-Festival-Pandaemonium.png"))
  .catch(console.error);
  }
};
