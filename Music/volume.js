...
module.exports = {
  name: "volume",
  aliases: ["v"],
  description: "Lautstärke verändern",
  cooldown: 5,
  edesc: `Benutze diesen Command um die Lautstärke des Liedes zu verändern\nNutzung: ${PREFIX}volume <0-200>`,
...
execute(message, args) {
    ...
    .setColor("#F0EAD6")
    .setTitle(`🔊 Lautstärke ist: \`${queue.volume}%\``)
    ...
    .setColor("#F0EAD6")
    .setTitle(`🔊 Lautstärke geändert zu: \`${args[0]}%\`!`)  
